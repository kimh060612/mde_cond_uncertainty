...
def main(cfg: DictConfig):
    ...
    for epoch in range(1, cfg.training.num_epochs + 1):
        train_metrics, global_step = train_one_epoch(
            ...
            group_size=group_size,
            use_optimal_loss=cfg.training.use_optimal_loss,
            optimal_loss_weight=cfg.training.optimal_loss_weight,
            optimal_softmax_temperature=cfg.training.optimal_softmax_temperature,
