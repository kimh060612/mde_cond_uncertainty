...
from finetune.finetune_dataset import MDEFineTuningDataset
...
def main(cfg: DictConfig) -> None:
    ...
    train_set = MDEFineTuningDataset(
        **common, topologies=cfg.dataset.train_topologies
    )
    val_set = MDEFineTuningDataset(
        **common,
        topologies=list(cfg.dataset.seen_val_topologies)
